  ...
  <div class="container pt-5">
    ...
    <div class="row">
      <div class="col-lg-6 mb-5 blog-item">
        <img className="img-fluid mb-4" src={require('../img/blog-1.jpg')} alt="Image" />
        ...
        <p>
          ...
          erat nonumy labore lorem ut eos, sed ut at tempor diam no. Kasd sit ea
          amet lorem et sea, ipsum sed dolor dolores sed dolore eirmod vero
      ...
      <div class="col-lg-6 mb-5 blog-item">
        <img class="img-fluid mb-4" src={require('../img/blog-2.jpg')} alt="Image" />
        <div class="d-flex align-items-center mb-4">
